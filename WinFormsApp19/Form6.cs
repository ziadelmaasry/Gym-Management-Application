...
namespace WinFormsApp19
{
    public partial class AddCustomer : Form
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Gym Application\database\Payment.mdf;Integrated Security=True;Connect Timeout=30");
